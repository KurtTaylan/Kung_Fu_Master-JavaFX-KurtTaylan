...
public class Dwarf extends Actor {
    ...
    private final Image[] enemyPics = new Image[8];
    ...
    public Dwarf(String name, String filename, int sizeX, int sizeY) {
        super(name, filename, sizeX, sizeY);
        enemyPics[0] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_standing_left.png"));
        enemyPics[1] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_standing_right.png"));
        enemyPics[2] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_walking_left.png"));
        enemyPics[3] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_walking_right.png"));
        enemyPics[4] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_rolling1.png"));
        enemyPics[5] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_rolling2.png"));
        enemyPics[6] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_rolling3.png"));
        enemyPics[7] = new Image(getClass().getResourceAsStream("/resources/" + "dwarf_rolling4.png"));
    ...
    public void doEnemyMovementStrategy() {
        if(!moveMode && !attackMode && !waitMode && this.atHorizontalEdge()){
            ...
            facingRight();
            timePauseCounter++;
            if(timePauseCounter >= 200+rand.nextInt(400)){
        ...
        if (waitMode){
            timePauseCounter++;
            if(timePauseCounter> 150+rand.nextInt(300)){                       
                this.setAttack(false);
                this.setMove(true);
                facingRight = false;
                timePauseCounter=0;
    ...
    public void dwarfColidesWith(){
        if(this.collidesWith(Game.getInstance().master) && this.isAttack()){
